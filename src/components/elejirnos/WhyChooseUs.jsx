...
const WhyChooseUs = () => {
  return (
    <section className="flex flex-col md:flex-row h-auto md:h-[500px]  w-full">
      {/* Lado izquierdo */}
      <div className="bg-oklchBlue text-white flex-1 flex flex-col items-center justify-center">
